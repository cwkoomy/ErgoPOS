        ...
        <CCard class="mb-4">
          <CCardBody>
            ...
            <CTable align="middle" class="mb-0 border" hover responsive>
              ...
              <CTableBody>
                <CTableRow v-for="dtdetail of dtdetails" :key="dtdetail.ID">
            ...
            <!-- <CTable>
              <CTableHead color="dark">
                <CTableRow>
                  ...
                  <CTableHeaderCell scope="col">Trx Amount</CTableHeaderCell>
                  <CTableHeaderCell scope="col">Trx Category</CTableHeaderCell>
              ...
              <CTableBody>
                <CTableRow v-for="dtdetail of dtdetails" :key="dtdetail.ID">
                  ...
                  <CTableDataCell>{{ dtdetail.MerchantID }}</CTableDataCell>
                  <CTableDataCell>{{
                    dtdetail.TxAmount + '.00'
                  }}</CTableDataCell>
                  <CTableDataCell>{{ dtdetail.TxCategory }}</CTableDataCell>
                  <CTableDataCell>{{
                    dtdetail.CreatedDateTime
                  }}</CTableDataCell>
                </CTableRow>
